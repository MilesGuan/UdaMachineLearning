...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        for key in dict:
            if dict[key] > maxQ:
                ...
                maxQ_action.append(key)
        return maxQ_action[random.randint(0, len(maxQ_action) - 1)]
    ...
    def createQ(self, state):
        ...
        #     self.Q[state] = dict()
        #     for va   lid_action in self.valid_actions:
        #         self.Q[state][valid_action] = 0
    ...
    def choose_action(self, state):
        ...
        elif random.uniform(0, 1) < self.epsilon:  # exploration
            action = self.valid_actions[random.randint(0, 3)]
        else:
...
def run():
    ...
    # sim = Simulator(env,update_delay = 2,log_metrics=False,display=True)
